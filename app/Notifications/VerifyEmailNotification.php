...
class VerifyEmailNotification extends VerifyEmail implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Verify your AI Orbit email')
            ->greeting('Welcome to AI Orbit, '.$notifiable->name.'!')
            ...
            ->line('If you did not create an AI Orbit account, you can ignore this email.');
    }
}
