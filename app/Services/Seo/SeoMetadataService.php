...
class SeoMetadataService
{
    ...
    private function titleCore(string $pageType, string $primary, ?Model $entity, ?string $fallbackTitle): string
    {
        ...
        return match ($pageType) {
            ...
            'comparisons_directory' => $primary.': Compare Models Side by Side',
    ...
    private function descriptionFor(
        ...
        return match ($pageType) {
            ...
            'comparisons_directory' => "Use AI Orbit's AI model comparison tool to compare AI models and tools side by side across pricing, benchmarks, context, capabilities and practical product differences.",
