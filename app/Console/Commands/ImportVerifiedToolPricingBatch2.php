...
class ImportVerifiedToolPricingBatch2 extends Command
{
    protected $signature = 'pricing:import-tool-batch2
        ...
        {--dataset=v1-2026-08-27 : Required verified dataset version}';

    protected $description = 'Import official-source verified pricing for AI Orbit tool pricing batch 2.';

    public function handle(): int
    {
        if ($this->option('dataset') !== 'v1-2026-08-27') {
            $this->error('Unsupported dataset. Use --dataset=v1-2026-08-27.');
            return self::FAILURE;
        }

        $file = storage_path('app/import-templates/verified-tool-pricing-v1-2026-08-27-batch2.csv');
        if (! is_file($file)) {
        ...
        $this->info('Verified tool pricing dataset: v1-2026-08-27 / Batch 2');
