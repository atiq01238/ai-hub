...
class ImportVerifiedToolPricingBatch1 extends Command
{
    protected $signature = 'pricing:import-tool-batch1
        ...
        {--dataset=v3-2026-08-27 : Required verified dataset version}';

    protected $description = 'Import official-source verified pricing for AI Orbit tool pricing batch 1.';

    public function handle(): int
    {
        if ($this->option('dataset') !== 'v3-2026-08-27') {
            $this->error('Unsupported dataset. Use --dataset=v3-2026-08-27.');
            return self::FAILURE;
        }

        $file = storage_path('app/import-templates/verified-tool-pricing-v3-2026-08-27-batch1.csv');
        if (! is_file($file)) {
        ...
        $this->info('Verified tool pricing dataset: v3-2026-08-27 / Batch 1');
