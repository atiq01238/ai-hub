...
<head>
    ...
    <title>Forgot Password — AI Hub</title>
    ...
    <main class="auth-panel">
        ...
        <section class="auth-card auth-recovery-card" aria-labelledby="forgot-title">
            ...
            <form method="POST" action="{{ route('password.email') }}" novalidate>
                ...
                <div class="auth-recovery-note">For privacy, AI Hub shows the same confirmation whether or not the email is registered.</div>
