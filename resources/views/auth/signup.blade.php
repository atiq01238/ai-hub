...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/frontend/auth-unified.css') }}?v=20260827-2">
</head>
<body>
<div class="auth-shell">
    ...
    <main class="auth-panel">
        ...
        <section class="auth-card" aria-labelledby="signup-title">
            ...
            <div class="auth-socials is-single auth-socials-single" aria-label="Social sign up">
            ...
            <p class="auth-social-legal">By continuing with Google, you agree to the <a href="{{ route('terms') }}" target="_blank" rel="noopener">Terms of Service</a> and <a href="{{ route('privacy') }}" target="_blank" rel="noopener">Privacy Policy</a>.</p>
