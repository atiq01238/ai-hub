...
<head>
    ...
    <title>Create Account — AI Hub</title>
    <link rel="stylesheet" href="{{ asset('css/frontend/auth-unified.css') }}">
</head>
<body>
<div class="auth-shell">
    <section class="auth-hero is-signup" aria-label="AI Hub discovery platform">
    ...
    <main class="auth-panel">
        ...
        <section class="auth-card" aria-labelledby="signup-title">
            ...
            <p class="auth-subtitle">Join AI Hub and unlock the full experience.</p>
            ...
            <div class="auth-socials" aria-label="Social sign up coming soon">
                <button class="auth-social" type="button" disabled title="Google sign up coming soon">
                ...
                <button class="auth-social" type="button" disabled title="Apple sign up coming soon">
