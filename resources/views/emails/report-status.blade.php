...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td align="center">
    <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="width:100%;max-width:600px;background:#ffffff;border:1px solid #dfe4ee;border-radius:14px;overflow:hidden;">
        <tr><td style="padding:24px 28px;background:linear-gradient(135deg,#5b7fff,#8b5cf6);color:#fff;"><b style="font-size:20px;">AI Orbit Trust & Safety</b></td></tr>
        <tr><td style="padding:28px;">
            ...
            @endif
            <p style="font-size:12px;color:#8792a6;margin-top:24px;">Thank you for helping keep the AI Orbit community accurate and safe.</p>
        </td></tr>
    </table>
</td></tr></table>
</body>
