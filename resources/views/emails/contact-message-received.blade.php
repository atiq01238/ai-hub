...
<tr><td style="padding:24px 28px;background:linear-gradient(135deg,#5b7fff,#8b5cf6);color:#fff;"><b style="font-size:20px;">AI Hub Contact Inbox</b></td></tr>
<tr><td style="padding:28px;">
<h1 style="font-size:22px;margin:0 0 8px;">New contact message</h1>
<p style="margin:0 0 20px;color:#65738b;">A user submitted a message through the AI Hub Contact Us form.</p>
