...
<section class="category-detail-hero">
    <div class="category-detail-inner">
        ...
        <div class="category-hero-main">
            <a class="breadcrumb-link" href="{{ route('categories.show', $category) }}">
            ...
            <p>
                {{ $subcategory->description ?: $subcategory->short_description }}
            </p>

            <div class="category-hero-actions">
                <a class="primary-action" href="#subcategory-tools">
                    Explore tools
                ...
                <a
                    ...
                    href="{{ route('search.index', ['q' => $subcategory->name]) }}"
                >
                    Search this topic
        ...
        <div class="category-stat-board">
            <span>
                <strong>{{ number_format($tools->total()) }}</strong>
...
<div class="discovery-page category-detail-page">
    ...
    <section id="subcategory-tools" class="result-section">
        ...
        <div class="section-bar category-tools-bar">
            ...
            <div>
                ...
                <h2>Top {{ $subcategory->name }} Tools</h2>

                <small>
                    {{ number_format($tools->total()) }} products
                </small>
            </div>

            <form method="get" class="sort-form">
                <label for="subcategory-sort">Sort</label>
        ...
        @else
            ...
            <div class="inline-empty">
                ...
                <div>
                    ...
                    <p>
                        This subcategory is ready for future listings.
                    </p>
                </div>
    ...
    @if($models->isNotEmpty())
        ...
        <section class="result-section">
            ...
            <div class="section-bar">
                ...
                <div>
                    <span class="section-icon cyan">
                        <i data-lucide="cpu"></i>
                    </span>

                    <h2>Related AI Models</h2>
                </div>

            </div>

            <div class="category-model-grid">

                @foreach($models as $model)

                    <a
                        class="category-model-card"
                    ...
                    >
                        ...
                        <div>
                            <small>{{ $model->company?->name }}</small>
                        ...
                        <b>
                            {{ $model->benchmark_score !== null
                                ? number_format((float) $model->benchmark_score, 1)
                                : '—'
                            }}
                        </b>
    ...
    @if($relatedSubcategories->isNotEmpty())

        <section class="related-category-strip">
            ...
            <div class="related-category-links">

                @foreach($relatedSubcategories as $related)
