...
@section('title','Personalize My AI Hub')
...
<span class="onboard-kicker"><i data-lucide="sparkles"></i> PERSONALIZE YOUR AI HUB</span>
<h1>What should AI Hub find for you?</h1><p>These choices tune recommendations. You can change them later.</p>
...
<button class="onboard-submit">Build my personalized AI Hub <i data-lucide="arrow-right"></i></button>
</form></div></section>
@endsection