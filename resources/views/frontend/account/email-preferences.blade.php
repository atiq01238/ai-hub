...
@section('title','Email Preferences — My AI Orbit')
...
<header class="account-subhead"><div><span class="account-kicker"><i data-lucide="mail"></i> EMAIL INTELLIGENCE</span><h1>Email preferences</h1><p>Choose which AI Orbit updates should reach your inbox. Transactional security emails are not affected.</p></div></header>
...
<section class="account-panel email-pref-master"><div><h2>AI Orbit intelligence emails</h2><p>Master switch for news, discovery, pricing, benchmark and digest emails.</p></div><label class="email-switch"><input type="checkbox" name="email_enabled" value="1" @checked($preference->email_enabled)><span></span></label></section>
...
['weekly_digest','newspaper','Weekly AI Digest','A compact weekly summary of important AI Orbit intelligence.'],
]; @endphp
