...
@section('title', 'About AI Hub — Independent AI Discovery & Intelligence')
@section('meta_description', 'Learn how AI Hub helps people discover AI tools and models, compare products, follow pricing and news, and understand independent benchmark data.')
...
<section class="inst-hero">
    ...
    <div class="inst-wrap inst-hero-grid">
        <div>
            <span class="inst-eyebrow"><i data-lucide="brain-circuit"></i> About AI Hub</span>
            <h1>One place to understand the <span>AI landscape.</span></h1>
            <p>AI Hub is designed as a research-driven discovery layer for AI tools, models, companies, pricing, news, benchmarks and practical comparisons.</p>
...
<div class="inst-wrap inst-stack">
    <section class="inst-section">
        <div class="inst-section-head"><span>Our purpose</span><h2>Make AI research easier to navigate and easier to verify.</h2><p>Instead of treating every product page, model announcement and benchmark as an isolated source, AI Hub connects them into a structured research experience.</p></div>
    ...
    <section class="inst-split">
        <div class="inst-panel">
            <span class="inst-mini-title">What AI Hub covers</span>
    ...
    <section class="inst-callout">
        ...
        <div class="inst-actions"><a class="inst-btn primary" href="{{ route('submissions.create') }}">Suggest or correct data</a><a class="inst-btn" href="{{ route('contact') }}">Contact AI Hub</a></div>
    </section>
</div>
@endsection
